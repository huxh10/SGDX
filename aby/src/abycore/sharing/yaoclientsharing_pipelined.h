/**
 \file 		yaoclientsharing_pipelined.h
 ...
 \brief		Yao Client Sharing for Pipelined GC execution class.
 */
#ifndef __YAOCLIENTPIPELINESHARING_H__
#define __YAOCLIENTPIPELINESHARING_H__

#include "sharing.h"
#include <algorithm>
#include "yaosharing.h"

//#define DEBUGYAOPIPECLIENT

/**
 Yao Client Sharing class.
 */
class YaoClientPipeSharing: public YaoSharing {

public:
	/** Constructor of the class.*/
	YaoClientPipeSharing(e_role role, uint32_t sharebitlen, ABYCircuit* circuit, crypto* crypt) :
...
private:
	...
	vector<uint32_t> m_vClientOutputGates; /** Client output gates */
	...
	void AssignClientOutputBits();
};

#endif /* __YAOCLIENTPIPELINESHARING_H__ */
