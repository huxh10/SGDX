...
public:
	...
	*/
	share* PutSubsetGate(share* input, uint32_t* posids, uint32_t nvals, bool copy_posids = true);
	...
	*/
	...
	uint32_t PutSubsetGate(uint32_t input, uint32_t* posids, uint32_t nvals, bool copy_posids = true);
